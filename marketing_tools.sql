...
(1, 9, 'uploading', 'ckeditor', '2020-12-03 08:14:41', NULL),
(2, 9, 'uploading', 'ckeditor', '2020-12-03 08:54:07', NULL),
(3, 9, 'uploading', 'ckeditor', '2020-12-03 08:54:40', NULL);
...
(1, 2, '0', 'uploads/ckeditor/Maple Eagle Freight Systems - Home Page.png', '2020-12-03 08:54:08', NULL),
(2, 3, '0', 'uploads/ckeditor/1605983117banner.jpg', '2020-12-03 08:54:40', NULL);
...
INSERT INTO `group` (`id`, `group_name`, `created_at`, `updated_at`) VALUES
(1, 'Test', '2020-12-03 05:03:17', NULL);

-- --------------------------------------------------------

--
-- Table structure for table `group_leads`
--

CREATE TABLE `group_leads` (
  `id` int(10) NOT NULL,
  `group_id` int(10) DEFAULT NULL,
  `leads_id` int(10) DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `group_leads`
--

INSERT INTO `group_leads` (`id`, `group_id`, `leads_id`, `created_at`, `updated_at`) VALUES
(1, 1, 1, '2020-12-03 05:08:31', NULL),
(2, 1, 1, '2020-12-05 12:00:18', NULL);
...
INSERT INTO `leads` (`id`, `first_name`, `last_name`, `company`, `email`, `cell_phone`, `skype`, `address`, `social_link`, `file_picture`, `created_at`, `updated_at`) VALUES
(1, 'Amirul', 'Momenin', NULL, 'amirrucst@gmail.com', '066565656', '', 'C-20,JAkir Hossain Road,Block-E\r\nMd-pur', '', NULL, '2020-12-03 05:07:48', '0000-00-00 00:00:00'),
(2, 'Amirul', 'Momenin', '', 'patainc@gmail.com', '066565656', '', 'C-20,JAkir Hossain Road,Block-E\r\nMd-pur', '', NULL, '2020-12-05 12:00:08', '0000-00-00 00:00:00');
...
CREATE TABLE `send_email` (
  ...
  `to_cc` varchar(256) DEFAULT NULL,
  `to_bcc` varchar(256) DEFAULT NULL,
  `group_id` int(10) DEFAULT NULL,
  `leads_id` int(10) DEFAULT NULL,
  `message` text
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `send_email` (`id`, `template_id`, `subject`, `to_email`, `to_cc`, `to_bcc`, `group_id`, `leads_id`, `message`) VALUES
(1, 1, 'Test', 'amirrucst@gmail.com', '', '', 0, 0, '&lt;p&gt;Test&lt;/p&gt;\r\n'),
(2, 0, 'Test', 'amirrucst@gmail.com', '', '', 0, 0, '&lt;p&gt;Test from Amirul&lt;/p&gt;\r\n'),
(3, 0, '', '', '', '', 1, 0, ''),
(4, 1, '43434', '', '', '', 0, 0, '&lt;p&gt;dfdfdf&lt;/p&gt;\r\n'),
(5, 0, 'Test', '', '', '', 0, 0, '&lt;p&gt;Test&lt;/p&gt;\r\n');
...
INSERT INTO `template` (`id`, `template_name`, `content`, `created_at`, `updated_at`) VALUES
(1, 'test', '<p>dgdgfg<img alt="" src="http://localhost/marketing_tools/public/uploads/ckeditor/1605983117banner.jpg" /></p>\r\n', '2020-12-03 08:54:45', NULL);
...
--
-- AUTO_INCREMENT for table `group_leads`
--
ALTER TABLE `group_leads`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
